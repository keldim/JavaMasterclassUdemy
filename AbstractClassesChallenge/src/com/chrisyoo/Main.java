...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Height jack = new Height(168);
        Height chris = new Height(178);
        Height mike = new Height(158);
        Height kobe = new Height(198);
        Height james = new Height(208);



        HeightList heights = new HeightList();
        heights.addItem(jack);
        System.out.println(heights.getHead().getValue());
        heights.printItems();
        heights.addItem(kobe);
        heights.printItems();
        heights.addItem(mike);
        heights.printItems();
        heights.addItem(chris);
        heights.printItems();
        System.out.println(heights.getHead().getValue());
        heights.addItem(james);
        heights.printItems();
        heights.removeItem(chris);
        heights.printItems();
        heights.removeItem(james);
        heights.printItems();
        heights.addItem(james);
        heights.printItems();
        heights.addItem(chris);
